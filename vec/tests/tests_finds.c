...
int find_first_one_option()
{
    ...
    size_t temp;
    size_t target = 2;
    VecStatus res = vec_find_first(&d, vec_default_condition, &temp, &target);
    if (res != VEC_OK)
        return 1;
    if (temp != 2)
        return 2;
...
int find_last_one_option()
{
    ...
    size_t temp;
    size_t target = 2;
    VecStatus res = vec_find_last(&d, vec_default_condition, &temp, &target);
    if (res != VEC_OK)
        return 1;
    if (temp != 2)
        return 2;
...
int binary_search_simple()
{
    ...
    size_t temp;
    size_t target = 2;
    VecStatus res = vec_binary_search(&d, vec_default_ordering, &temp, &target);
    if (res != VEC_OK)
        return 1;
    if (temp != 2)
        return 2;
