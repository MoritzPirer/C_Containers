...
///     VEC_OK if key was found (only then is the value at index_buffer valid)
/// @complexity O(log(n))
VecStatus vec_binary_search(vec_t *self, vec_ordering_t vec_ordering,
...
/// @complexity O(n)
VecStatus vec_transform(vec_t *self, vec_transformation_t transformation, const void *data);
