...
VecStatus vec_init(vec_t *self, size_t initial_size, size_t element_size);
...
VecStatus vec_destroy(vec_t *self);
...
VecStatus vec_swap(vec_t *self, vec_t *other);
...
///     VEC_OK otherwise
VecStatus vec_copy(vec_t *original, vec_t *copy);
...
///     VEC_OK otherwise
VecStatus vec_append(vec_t *self, vec_t *other);
...
VecStatus vec_push_back(vec_t *self, void *source);
...
///     VEC_OK otherwise
VecStatus vec_pop_back(vec_t *self, void *destination);
...
///     VEC_OK otherwise
VecStatus vec_push_front(vec_t *self, void *source);
...
///     VEC_ERROR_ALLOCATION if resizing the vec failed,
///     VEC_OK otherwise
VecStatus vec_pop_front(vec_t *self, void *destination);
...
VecStatus vec_erase_from_to(vec_t *self, size_t start, size_t end);
...
///     VEC_ERROR_NULL if self is NULL,
///     VEC_ERROR_ALLOCATION if the shrinking failed, VEC_OK otherwise
VecStatus vec_erase_from(vec_t *self, size_t start);
...
///     VEC_ERROR_NULL if self is NULL,
///     VEC_ERROR_ALLOCATION if the shrinking failed, VEC_OK otherwise
VecStatus vec_erase_to(vec_t *self, size_t end);
...
///     VEC_ERROR_NULL if self is NULL,
///     VEC_ERROR_ALLOCATION if the shrinking failed, VEC_OK otherwise
VecStatus vec_erase_at(vec_t *self, size_t index);
...
///     VEC_ERROR_NULL if self is NULL,
///     VEC_ERROR_ALLOCATION if the shrinking failed, VEC_OK otherwise
VecStatus vec_erase_all(vec_t *self);

/// @brief alias for vec_erase_all
VecStatus vec_clear(vec_t *self);
